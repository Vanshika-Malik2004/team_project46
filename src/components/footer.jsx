  ...
  return (
    <div className="relative pb-16 pt-20 text-center sm:py-24">
      ...
      <p className="mx-auto mt-6 max-w-xs text-sm/6 text-gray-500">
        Unlock the secrets to healthier skin with instant, AI-driven analysis
...
function SitemapLink(props) {
  return (
    <li>
      <Link
        {...props}
        className="data-hover:text-gray-950/75 font-medium text-gray-950"
      />
    </li>
  );
}
  ...
  return (
    <>
      <Link
        ...
        className="data-hover:text-gray-950/75 text-gray-950"
      >
